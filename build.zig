...
pub fn build(b: *std.Build) !void {
    ...
    const playdate_tests = b.addTest(.{
        .root_module = playdate_module,
        .test_runner = test_runner,
        .filters = test_filter,
    });
    b.installArtifact(playdate_tests);
    const run_playdate_tests = b.addRunArtifact(playdate_tests);
